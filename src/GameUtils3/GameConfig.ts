...
class GameConfig {
    ...
    public static GAMETYPEID: number = 0;
    ...
    /**开发游戏配置 */
    public static DICBW = 54;
    public static DICBH = 54;
    public static BROW = 17;         //列数
    public static BCOL = 10;         //行数
    public static offstart = { x: 32, y: 20 };
    public static MAXBLOCK = 16;
    /**开发游戏配置结束 */
